//altclkctrl CBX_SINGLE_OUTPUT_FILE="ON" CLOCK_TYPE="Global Clock" DEVICE_FAMILY="MAX 10" ENA_REGISTER_MODE="falling edge" USE_GLITCH_FREE_SWITCH_OVER_IMPLEMENTATION="ON" clkselect ena inclk outclk
...
module  clkswitcher_altclkctrl_0_sub
	( 
	clkselect,
	ena,
	inclk,
...
endmodule //clkswitcher_altclkctrl_0_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  clkswitcher_altclkctrl_0  (
    clkselect,
    inclk0x,
    inclk1x,
    outclk);
...
`endif
    ...
    clkswitcher_altclkctrl_0_sub  clkswitcher_altclkctrl_0_sub_component (
                .clkselect (sub_wire2),
                .ena (sub_wire4),
                .inclk (sub_wire6),
                .outclk (sub_wire0));
